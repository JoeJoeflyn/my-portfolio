...
export async function generateMetadata() {
  return {
    title: "Projects - Nguyen Thai Tai",
    description:
          ...
          <div className="mx-auto max-w-2xl lg:max-w-5xl">
            <header className="max-w-2xl">
              ...
              <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
                I&apos;ve worked on several projects in the past few years, and
              ...
              >
                <li className="group relative flex flex-col items-start">
                  <div className="relative z-10 flex h-12 w-12 items-center justify-center rounded-full bg-white shadow-md shadow-zinc-800/5 ring-1 ring-zinc-900/5 dark:bg-zinc-700 dark:shadow-zinc-900/10 dark:ring-zinc-600">
                    ...
                    <div className="dark:block dark:visible hidden">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24"
                        width={24}
                  ...
                  <h2 className="mt-6 text-base font-semibold text-zinc-800 dark:text-zinc-100">
                    ...
                    <Link
                      href="https://github.com/JoeJoeflyn/my-portfolio"
                      target="_blank"
                    >
                ...
                <li className="group relative flex flex-col items-start">
                  ...
                  <h2 className="mt-6 text-base font-semibold text-zinc-800 dark:text-zinc-100">
                    <div className="absolute -inset-y-6 -inset-x-4 z-0 scale-95 bg-zinc-50 opacity-0 transition group-hover:scale-100 group-hover:opacity-100 dark:bg-zinc-800/50 sm:-inset-x-6 sm:rounded-2xl"></div>
                    <Link
                      href="https://github.com/JoeJoeflyn/discord-bot"
                      target="_blank"
                    >
                      <span className="absolute -inset-y-6 -inset-x-4 z-20 sm:-inset-x-6 sm:rounded-2xl"></span>
                      <span className="relative z-10">Discord bot</span>
                    </Link>
                  </h2>
                  <p className="relative z-10 mt-2 text-sm text-zinc-600 dark:text-zinc-400">
                  ...
                  <p className="relative z-10 mt-6 flex text-sm font-medium text-zinc-400 transition group-hover:text-teal-500 dark:text-zinc-200">
                    ...
                    <span className="ml-2">discord-bot</span>
                  </p>
                </li>
                <li className="group relative flex flex-col items-start">
                  <div className="relative z-10 flex h-12 w-12 items-center justify-center rounded-full bg-white shadow-md shadow-zinc-800/5 ring-1 ring-zinc-900/5 dark:bg-zinc-700 dark:shadow-zinc-900/10 dark:ring-zinc-600">
                  ...
                  <h2 className="mt-6 text-base font-semibold text-zinc-800 dark:text-zinc-100">
                    <div className="absolute -inset-y-6 -inset-x-4 z-0 scale-95 bg-zinc-50 opacity-0 transition group-hover:scale-100 group-hover:opacity-100 dark:bg-zinc-800/50 sm:-inset-x-6 sm:rounded-2xl"></div>
                    <Link
                      href="https://github.com/JoeJoeflyn/e-commerce-web"
                      target="_blank"
                    >
                      <span className="absolute -inset-y-6 -inset-x-4 z-20 sm:-inset-x-6 sm:rounded-2xl"></span>
                  ...
                  <p className="relative z-10 mt-2 text-sm text-zinc-600 dark:text-zinc-400">
                    An online store like Chotot or Ebay.
                  </p>
                  <p className="relative z-10 mt-6 flex text-sm font-medium text-zinc-400 transition group-hover:text-teal-500 dark:text-zinc-200">
                    <svg
                      viewBox="0 0 24 24"
                    ...
                    <span className="ml-2">e-commerce-web</span>
                  </p>
                </li>
              </ul>
            </div>
